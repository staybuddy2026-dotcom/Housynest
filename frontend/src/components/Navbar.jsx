    ...
    const fetchCounts = async () => {
      try {
        ...
        if (res.ok) {
          ...
          const totalUnread = (data.unreadMessages || 0) + (data.newRequests || 0) + (data.newLawyerRequests || 0) + (data.newVisits || 0);
                  ...
                  <div className="bg-white rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.08)] border border-slate-100 overflow-hidden relative">
                    ...
                    <div className="p-2 flex flex-col gap-1">
                      ...
                      >
                        ...
                        {unreadCount > 0 && (
                          <div className="bg-red-500 text-white text-[10px] font-bold px-1.5 py-0.5 min-w-[20px] rounded-full flex items-center justify-center">
                            {unreadCount}
                          </div>
                        )}
                      </Link>
