  ...
  return (
    <div className="w-full lg:h-full py-10 lg:py-6 lg:pl-16 flex flex-col justify-between relative">
      ...
      <div className={`transform transition-all duration-1000 ease-[cubic-bezier(0.2,0.8,0.2,1)] ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
        ...
        <div className="relative max-w-[380px] min-h-[340px] lg:h-[300px]">
          {/* Login Headline */}
      ...
      <div className={`mt-8 lg:mt-auto relative h-[140px] sm:h-[100px] lg:h-20 max-w-[420px] transform transition-all duration-1000 delay-150 ease-[cubic-bezier(0.2,0.8,0.2,1)] ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
