  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3">
      ...
      <div
        ...
        className={`py-3.5 px-4 sm:px-6 cursor-pointer transition-all duration-300 flex flex-col items-center justify-center text-center rounded-l-xl ${currentStep === 1
      ...
      >
        <span className="text-xs font-bold block mb-0.5">1</span>
        <p className="text-xs sm:text-sm font-bold leading-tight">Complete Profile</p>
      ...
      <div
        ...
        className={`py-3.5 px-4 sm:px-6 cursor-pointer transition-all duration-300 flex flex-col items-center justify-center text-center ${currentStep === 2
            ? 'bg-[#062F26] text-white shadow-md'
            : currentStep > 2
              ? 'bg-[#EAF5F2] text-[#062F26] hover:bg-[#d8ece6]'
              : 'bg-white text-slate-700 hover:bg-slate-50 border border-slate-200/60 shadow-2xs'
      ...
      >
        <span className="text-xs font-bold block mb-0.5">2</span>
        <p className="text-xs sm:text-sm font-bold leading-tight">Document Verification</p>
      ...
      <div
        ...
        className={`py-3.5 px-4 sm:px-6 cursor-pointer transition-all duration-300 flex flex-col items-center justify-center text-center rounded-r-xl ${currentStep === 3
            ? 'bg-[#062F26] text-white shadow-md'
            : 'bg-white text-slate-700 hover:bg-slate-50 border border-slate-200/60 shadow-2xs'
          }`}
      >
        <span className="text-xs font-bold block mb-0.5">3</span>
