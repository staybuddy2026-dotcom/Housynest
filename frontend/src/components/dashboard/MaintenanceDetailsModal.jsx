...
const MaintenanceDetailsModal = ({ ticket, onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-slate-900/50 backdrop-blur-sm animate-fadeIn">
      <div 
        className="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90dvh] flex flex-col animate-slideUp"
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-y-auto p-5 flex flex-col md:flex-row gap-6 custom-scrollbar">
          ...
          <div className="md:w-1/2 flex flex-col gap-4">
            ...
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex items-center gap-3 shrink-0">
        ...
        <div className="p-4 sm:p-5 border-t border-slate-100 flex flex-col sm:flex-row justify-end gap-3 bg-slate-50 rounded-b-2xl shrink-0">
          ...
          <button 
            ...
            disabled={loading}
            className="w-full sm:w-auto px-5 py-2.5 rounded-lg text-sm font-bold text-white bg-brand-teal hover:bg-[#062F26] transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
          >
