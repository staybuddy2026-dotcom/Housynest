...
const PropertyQuickStats = ({ property, propertyType }) => {
  return (
    <div className="w-full grid grid-cols-2 sm:flex sm:flex-wrap items-center justify-start sm:justify-between gap-6 sm:gap-4 bg-white rounded-xl shadow-[0_4px_30px_rgba(0,0,0,0.03)] p-6 lg:p-7 mb-8 border border-slate-50">
      {propertyType !== 'PG' && (
        <>
