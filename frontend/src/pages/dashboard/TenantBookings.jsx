    ...
    <div className="pb-10 mx-auto space-y-4 animate-fadeIn">
      ...
      <div className="space-y-12">
        {bookings.map((booking) => {
          ...
          return (
            <div key={booking._id} className="flex flex-col lg:flex-row gap-4 border-b border-slate-200 pb-12 last:border-b-0 last:pb-0">
                  ...
                  <div className="p-5 flex flex-col sm:flex-row gap-6 relative">
                    ...
                    <div className="flex-1 flex flex-col justify-between py-1">
                      <div className="flex justify-between items-start">
                        <div>
                          <h2 className="text-xl font-extrabold text-[#062F26]">{booking.propertyId?.pgName || 'Property'}</h2>
                        ...
                        <span className={`px-3 py-1 font-bold text-xs rounded-lg border ${
                          booking.status === 'Confirmed' || booking.status === 'Active' || booking.status === 'Reserved'
