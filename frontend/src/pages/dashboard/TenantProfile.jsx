    ...
    <div className="animate-fadeIn max-w-3xl mx-auto pb-10">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm mb-6 flex items-center gap-5">
        <div className="relative group">
          <div className="w-16 h-16 bg-[#062F26] rounded-full flex items-center justify-center text-white text-2xl font-bold shrink-0 shadow-inner overflow-hidden">
            {formData.profilePic ? (
        ...
        <div>
          <h2 className="text-lg font-bold text-slate-800 leading-tight mb-1">{formData.fullName || 'Tenant Name'}</h2>
